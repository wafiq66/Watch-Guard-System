...
function validateForm() {
  var newPassword = document.forms["updateForm"]["residentNewPassword"].value;
  var confirmPassword = document.forms["updateForm"]["residentConfirmPassword"].value;
  var alertMessage = document.getElementById("alertMessage");
  

  if (newPassword !== confirmPassword) {
      alertMessage.innerHTML = "New Password and Confirm Password do not match.";
      return false;
  }
  else{
    var userConfirmed = confirm("Confirm Edit?");
    if (userConfirmed) {
...
function registerForm() {
  ...
  if (newPassword !== confirmPassword) {
    ...
    var userConfirmed = confirm("Confirm Register?");
    if (userConfirmed) {
      return true;
    } else {
      alert("Update canceled.");
...
function deleteForm() {
    ...
    var userConfirmed = confirm("Confirm Remove Tenant?");
    if (userConfirmed) {
      return true;
    } else {
      return false;
